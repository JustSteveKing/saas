...
\Laravel\Folio\name('pages:auth:onboarding'); ?>

<x-page title="Finish Onboarding">
            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    ...
                    <p class="mt-2 text-sm leading-6 text-gray-500">
                        Not a member?
                        <x-link href="pages:auth:register" title="Create a new Account">
                ...
                <div class="mt-10">
                    ...
                    <div class="mt-10">
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-4">
                            ...
                            <a href="{{ route('pages:auth:github:redirect') }}" class="flex w-full items-center justify-center gap-3 rounded-md bg-[#24292F] px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#24292F]">
